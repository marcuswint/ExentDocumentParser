        ...
        Try
            ...
            If SoapException Is Nothing Then
                ...
                For Each Name As XmlNode In Names
                    CompanyName = getNodeValue(Name, "./abn:mainTradingName/abn:organisationName")
                    If CompanyName = "" Then CompanyName = getNodeValue(Name, "./abn:mainName/abn:organisationName")
                Next
            Else
